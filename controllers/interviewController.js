...
`,
        ...
        // Remove markdown if OpenRouter returns ```json ... ```
...
export const finishInterview = async (req, res) => {
    try {
        ...
        const avgCorrection = totalQuestion ? totalCorrectness / totalQuestion : 0;
        ...
        return res.status(500).json({ message: `Failed to finsish Interview ${error}` });
    }
}
